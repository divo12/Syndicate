...
import syndicate.services.candidate_seal as candidate_seal
from syndicate.models.candidate import CandidateValidationError
...
def test_seal_rechecks_for_symlinks_after_initial_scan(
    ...
    original_files = candidate_seal._candidate_files
    ...
    monkeypatch.setattr(candidate_seal, "_candidate_files", swap_after_scan)
...
def test_seal_rejects_changed_content_during_recheck(
    ...
    monkeypatch.setattr(candidate_seal, "_read_candidate_file", changing_read)
...
def test_seal_rechecks_the_tree_after_capturing_content(
    ...
    monkeypatch.setattr(
        candidate_seal, "_candidate_files", add_protected_file_after_scan
    )
...
def test_seal_rechecks_content_after_capturing_it(
    ...
    monkeypatch.setattr(candidate_seal, "_candidate_files", change_file_on_second_scan)
