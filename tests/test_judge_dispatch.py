...
from syndicate.models.evidence import RecordCitation, RunEvidenceGrant
from syndicate.models.judging import JudgeAttempt, JudgeSpec, ReportStatus
...
from syndicate.services.judge_dispatch import (
    attempt_from_receipt,
    dispatch_judge,
    role_tools,
)
from syndicate.services.judging import JudgeEvidence, JudgeRegistry
...
def test_role_failure_becomes_accounted_incomplete_report(
    ...
    monkeypatch.setattr("syndicate.services.judge_dispatch.dispatch_role", failed)
