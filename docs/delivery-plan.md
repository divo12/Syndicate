...
P14 [PR #9](https://github.com/divo12/Syndicate/pull/9) provides schema/public-provenance validation and pinned specifications. Historical head `a7cdf16` is superseded; use the linked PR's pinned review head; this is separate from P15 integration and does not establish semantic judge validity.
