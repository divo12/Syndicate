...
The complete project schedule remains orchestrator-owned; these labels are task
IDs, not GitHub PR numbers. Each PR must remain below 500 additions + deletions,
...
| M1 T1 | S3 / P07b | Concrete nonroot container backend and transient capture | P07 | [#11](https://github.com/divo12/Syndicate/pull/11) |

```mermaid
flowchart LR
  M0[M0 gate] --> P06[P06 seed and pinned prompt]
  P06 --> P07[P07 shell interface]
  P07 --> P07b[P07b concrete container backend]
